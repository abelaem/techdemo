...
namespace TechTest.Tests.Controllers
{
    ...
    public class PeopleControllerTests
    {
        ...
        public void GetAll_Calls_Repository()
        {
            ...
            mockRepo.Setup(repo => repo.Persons.GetAll()).Returns(GetTestPeople().AsEnumerable());
            ...
            // Assert
            mockRepo.Verify(mock => mock.Persons.GetAll(), Times.Once());
        }
        ...
        public void GetAll_Returns_Empty_List()
        {
            // Arrange
            var mockRepo = new Mock<IUnitofWork>();
            mockRepo.Setup(repo => repo.Persons.GetAll()).Returns(EmptyList);
            var controller = new PeopleController(mockRepo.Object);
        ...
        public void Get_Calls_Repository()
        {
            ...
            mockRepo.Setup(repo => repo.Persons.Get(personId))
            ...
            // Assert
            mockRepo.Verify(mock => mock.Persons.Get(personId), Times.Once());
        }
        ...
        public void Update_Calls_Repository()
        {
            ...
            mockRepo.Setup(repo => repo.Persons.Update(person))
                    .Returns(person);
            ...
            // Assert
            mockRepo.Verify(mock => mock.Persons.Get(personId), Times.Once());
            mockRepo.Verify(mock => mock.Persons.Update(person), Times.Once());
        }
        ...
        public void Update_Returns_NotFound()
        {
            ...
            mockRepo.Setup(repo => repo.Persons.Update(It.IsAny<Person>()))
                    .Returns(null as Person);
